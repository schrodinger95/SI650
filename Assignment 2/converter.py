...
if __name__ == '__main__':
    ...
    if not os.path.exists('integrations'):
        os,os.makedirs('integrations')
    if not os.path.exists('integrations/resources'):
        os.makedirs('integrations/resources')
    if not os.path.exists('integrations/resources/collection'):
        os.makedirs('integrations/resources/collection')

    document_path = sys.argv[1]
    filename = 'integrations/resources/collection/document.jsonl'
    ...
    if len(sys.argv) == 3:
        ...
        filename = 'integrations/resources/query.tsv'
